...
helm.sh/chart: {{ include "ingest-service.chart" . }}
...
*/}}
{{- define "ingest-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "ingest-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
